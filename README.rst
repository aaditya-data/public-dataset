# 📊 Public DataSet  
A curated collection of high-quality, publicly available datasets for learning Data Analysis, SQL, Machine Learning, and building portfolio projects.

This repository is maintained by **Aaditya**, created to help students, beginners, and professionals easily find clean, reliable datasets for practice.

---

## 🎯 Purpose of This Repository  
Finding good datasets is one of the biggest challenges for beginners.  
So, I created **Public DataSet** to make it easy to:

- Practice data analysis  
- Build dashboards (Excel / Power BI / Tableau)  
- Practice SQL queries  
- Learn Python & machine learning  
- Create strong portfolio projects  
- Prepare for internships and data analyst job roles  

If you're looking for datasets to start your journey, this repo gives you everything in one place.
...
I do not own most datasets listed in this repository.  
All datasets belong to their original creators.  
This repository only provides **public links** for educational and research purposes.

---

## ⭐ Support the Project  

If this repo helps you in your data learning journey, please consider giving it a ⭐ on GitHub.  
It motivates me to keep adding more datasets!
